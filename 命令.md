...
```
sudo update-alternatives --install /usr/bin/java java /usr/java/jdk18/bin/java 300
sudo update-alternatives --install /usr/bin/javac javac /usr/java/jdk18/bin/javac 300
